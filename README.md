...
[![Status](https://img.shields.io/badge/status-v1.0-green)](https://github.com/yosuke-seno/gassign)

---

## [▶ gassign をコピーして使い始める](https://script.google.com/d/15V9FPuzkNj7Cetguhl4SxM0r-YDq_ZAVFavqISaMQumWz-3Ea6NTOACT/copy)
...
```bash
git clone https://github.com/yosuke-seno/gassign.git
cd gassign
...
- **不具合報告**: [GitHub Issues](https://github.com/yosuke-seno/gassign/issues) へお願いします。
